...
To scale out the number of units via the terraform *enable_ha* action. The only requirement is to be an odd number.

### Scale in

To scale in you need to manually do via `juju remove-machine`.
