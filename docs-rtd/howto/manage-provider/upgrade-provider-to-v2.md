...
**Juju 4.x controllers:** v2 is the first provider release to support Juju 4. If you want to upgrade your Juju models or controllers to Juju 4, upgrade your Juju infrastructure first, then upgrade the Terraform provider to v2.
