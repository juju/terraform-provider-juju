...
// Source: github.com/juju/terraform-provider-juju/internal/juju (interfaces: SharedClient,ClientAPIClient,ApplicationAPIClient,ModelConfigAPIClient,ResourceAPIClient,SecretAPIClient,SSHKeyManagerClient,JaasAPIClient,CloudAPIClient,CommandRunner)
//
// Generated by this command:
//
//	mockgen -typed -package juju -destination mock_test.go github.com/juju/terraform-provider-juju/internal/juju SharedClient,ClientAPIClient,ApplicationAPIClient,ModelConfigAPIClient,ResourceAPIClient,SecretAPIClient,SSHKeyManagerClient,JaasAPIClient,CloudAPIClient,CommandRunner
//
