...
//go:generate go run github.com/hashicorp/terraform-plugin-docs/cmd/tfplugindocs generate --rendered-website-dir docs-rtd/reference/terraform-provider
...
func main() {
	...
	if err := tf6server.Serve(
		...
		providerserver.NewProtocol6(provider.NewJujuProvider(version, provider.ProviderParams{WaitForResources: true})),
		serveOpts...,
	); err != nil {
