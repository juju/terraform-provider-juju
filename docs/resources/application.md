...
- `resource` (Block Set) Resource to associate with the application. (see [below for nested schema](#nestedblock--resource))
...
- `oci_image` (String) OCI image to use for the resource.
